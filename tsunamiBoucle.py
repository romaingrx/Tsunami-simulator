...
#    print(Tsunami.U[0:10,:])
    for iElem in range(theSize):
        for k in range(3):
            Tsunami.E[iElem,k] += dt * Tsunami.iterE[iElem,k] 
            Tsunami.U[iElem,k] += dt * Tsunami.iterU[iElem,k] 
            Tsunami.V[iElem,k] += dt * Tsunami.iterV[iElem,k] 
    return 
